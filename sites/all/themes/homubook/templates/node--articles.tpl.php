 ...
 */
?>
<h1 class="page_header h2"><?php print $title; ?></h1>

      <?php if (!empty($field_subtitle)): ?>
      <h2 class="subtitle h4"><?php print $content['field_subtitle']['0']['#markup']; ?></h2>
      <?php endif; ?>

      <!-- author section -->
      <div class="submitted">
        <?php print $user_picture; ?>
        <div class="user-information"><?php print $submitted; ?><br>homubook editor</div>
      </div>
